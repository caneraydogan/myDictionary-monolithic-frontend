...
@Component({
  selector: 'app-practice-verb',
  templateUrl: './practice-verb.component.html',
  styleUrls: ['./practice-verb.component.css']
})
export class PracticeVerbComponent implements OnInit {
